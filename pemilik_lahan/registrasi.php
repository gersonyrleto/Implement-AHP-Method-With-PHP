        ...
        <div class="container">
			...
			<section class="main">
				<form class="form-2" method="post">
					...
					<p class="float">
						<label for="login">Kode User</label>
						<input type="text" name="kode" placeholder="Kode"  style="width: 207%;" required>
						...
						<?php 
			            		...
			            		elseif (isset($status) && $status == "admin") echo "checked";
			            		// elseif (isset($status) && $status == "ketua") echo "checked";
            			?>>
						<br/>
