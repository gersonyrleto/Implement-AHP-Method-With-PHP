...
elseif ($mod == 'alternatif_tambah') {
    $nama_alternatif = $_POST['pilih'];
    $kode_alternatif = $_POST['kode_alternatif'];
    
    if ($nama_alternatif == '')
        print_msg("Belum Ada Data Alterantif Yang Dipilih!");
    elseif ($db->get_results("SELECT nama_alternatif FROM tb_alternatif WHERE nama_alternatif = '$nama_alternatif'"))
        print_msg("Nama Alternatif Sudah Ada!");
    else {
        $row = $db->get_row("SELECT id_user FROM tb_user WHERE user = '$_SESSION[user]'");
        $id_user = $row->id_user;
        $db->query("INSERT INTO tb_alternatif (kode_alternatif, id_user, nama_alternatif) VALUES ('$kode_alternatif','$id_user','$nama_alternatif')");
...
elseif ($mod == 'kriteria_tambah') {
    ...
    elseif ($db->get_results("SELECT * FROM tb_kriteria WHERE kode_kriteria='$kode_kriteria'"))
        ...
        $row = $db->get_row("SELECT id_user FROM tb_user WHERE user = '$_SESSION[user]'");
        $id_user = $row->id_user;
        $db->query("INSERT INTO tb_kriteria (kode_kriteria, nama_kriteria, id_user) VALUES ('$kode_kriteria', '$nama_kriteria', '$id_user')");
