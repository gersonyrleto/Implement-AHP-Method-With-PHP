...
if (!$ALTERNATIF || !$KRITERIA) :
    echo "<div class='p-3 mb-2 bg-warning text-black' style='height: 50px; padding-top: 15px;'><center><strong>
          Data analisis kriteria dan alternatif belum ada. Silahkan masukan data dan lakukan analisis</strong></center></div><br>
            ";
...
?>
    ...
    <div class="panel panel-primary">
        ...
        <a class="btn btn-primary" href="halaman_pengusaha.php" style="margin-bottom: 40px;"><span class="glyphicon glyphicon-arrow-left"></span> Kembali Ke Menu Utama</a>
<?php endif ?>