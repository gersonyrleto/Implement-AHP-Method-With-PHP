<div class="col-xs-12 col-sm-12 col-md-2" style="padding: 2px 0px;">
      <div class="panel panel-primary">
              ...
              <div class="panel-body">
                <ul class="nav nav-pills nav-stacked">
                  <li role="presentation"><a href="halaman_pengusaha.php"><span class="glyphicon glyphicon-home"></span> Beranda</a></li>
                </ul>
              </div>
            </div>
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                ...
                <!--  <li role="presentation"><a href="nilai.php"><span class="fa fa-modx"></span> Data Nilai</a></li>-->
                  <li role="presentation"><a href="?m=kriteria"><span class="glyphicon glyphicon-list"></span> Data Kriteria</a></li>
               <!--    <li role="presentation"><a href="?m=alternatif"><span class="fa fa-book"></span> Data Lokasi</a></li> -->
                </ul>
              </div>
            </div>
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><span class="glyphicon glyphicon-ok-sign"></span> Informasi</h3>
              </div>
              <div class="panel-body">
                <ul class="nav nav-pills nav-stacked">
                  <li role="presentation"><a href="?m=alternatif"><span class="glyphicon glyphicon-map-marker"></span> Informasi Lahan</a></li>
                </ul>
              </div>
            </div>
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><span class=" glyphicon glyphicon-floppy-saved"></span> Analisis Data</h3>
              </div>
              <div class="panel-body">
                <ul class="nav nav-pills nav-stacked">
                  <li role="presentation"><a href="?m=rel_kriteria"><span class="glyphicon glyphicon-duplicate"></span> Analisis Kriteria</a></li>
                  <li role="presentation"><a href="?m=rel_alternatif"><span class="glyphicon glyphicon-duplicate"></span> Analisis Alternatif</a></li>
...
<div class="page-header" >
    <ol class="breadcrumb"style="width: 100%;">
      <li><a href="halaman_pengguna.php"><span class="glyphicon glyphicon-home"></span> Beranda</a></li>
      <li class="active"><span class="fa fa-bank"></span>Selamat Datang Di Halaman Calon Pengusaha / <strong><?= $data['nama_user']; ?></strong></li>
    </ol>
</div>
