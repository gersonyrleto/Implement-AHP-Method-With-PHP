...
$data = array();
foreach ($rows as $row) {
    $criterias[$row->kode_kriteria] = $row->nama_kriteria;
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                $total_nilai =get_total_kolom($normal);
                        ...
                        <tr>
                                <td>Total kolom</td>
                                <?php foreach ($total_nilai as $key => $val) : ?>
                                    <td class="text-primary"><?= round($total_nilai[$key], 4) ?></td>
                                <?php endforeach ?>
                                <td class="text-primary"><?= round($total_nilai[$key], 4) ?></td>
                        </tr>
                    </table>
            ...
            <div class="panel panel-default">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                $ttl = get_total_kolom($normal);

                                foreach ($matriks as $key => $val) : ?>
                                    <th><?= $key ?></th>
                                <?php endforeach ?>
                                <th>Total Pejumlahan</th>
                            </tr>
                        </thead>
                        <?php foreach ($normal as $key => $val) : ?>
                            <tr>
                        ...
                        <tr>
                                <td>Total kolom</td>
                                <?php foreach ($ttl as $key => $val) : ?>
                                    <td class="text-primary"><?= round($ttl[$key], 4) ?></td>
                                <?php endforeach ?>
                ...
                <div class="panel-footer">
                    ...
                    if ($CR > 0.10) {
                        ...
                        echo "<a class='btn btn-success' href='halaman_pengusaha.php?m=rel_alternatif'><span class='glyphicon glyphicon-right'></span> Lanjut Ke Perhitungan Alternatif Terhadap Kriteria</a>";
                    }
                    ?>
                </div>
            </div>
